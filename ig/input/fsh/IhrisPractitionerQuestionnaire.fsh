...
* item[0].item[0].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:unique-number.value[x]:valueString"
* item[0].item[0].text = "Unique Identification Number (UIN)"
...
* item[0].item[2].code[0].system = "attachment-types"
* item[0].item[2].code[0].code = #.png
* item[0].item[2].code[1].system = "attachment-types"
* item[0].item[2].code[1].code = #.jpeg
...
* item[0].item[3].answerValueSet = "http://ihris.org/fhir/ValueSet/tgo-gender-valueset"
...
* item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:spouse-name.value[x]:valueString"
* item[0].item[5].text = "Spouse Name"
* item[0].item[5].type = #string
* item[0].item[5].required = false
* item[0].item[5].repeats = false
* item[0].item[5].enableWhen[0].question = "Practitioner.extension[1]"
* item[0].item[5].enableWhen[0].operator = #=
* item[0].item[5].enableWhen[0].answerCoding = marital-status-codesystem#married
* item[0].item[5].enableWhen[1].question = "Practitioner.gender"
* item[0].item[5].enableWhen[1].operator = #=
* item[0].item[5].enableWhen[1].answerCoding = http://hl7.org/fhir/administrative-gender#female

* item[0].item[6].linkId = "Practitioner.birthDate"
* item[0].item[6].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.birthDate"
* item[0].item[6].text = "Date of Birth"
* item[0].item[6].type = #date
* item[0].item[6].required = true
* item[0].item[6].repeats = false

* item[0].item[7].linkId = "Practitioner.extension[3]"
* item[0].item[7].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:birth-place.value[x]:valueString"
* item[0].item[7].text = "Place of Birth"
...
* item[0].item[8].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.extension:nationality.value[x]:valueCoding"
* item[0].item[8].text = "Nationality"
* item[0].item[8].type = #choice
* item[0].item[8].answerValueSet = "http://ihris.org/fhir/ValueSet/nationality-valueset"
...
* item[1].item[0].item[4].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.address.extension:municipal.value[x]:valueReference"
* item[1].item[0].item[4].text = "Municipal"
* item[1].item[0].item[4].type = #reference
* item[1].item[0].item[4].required = false
* item[1].item[0].item[4].repeats = false

* item[1].item[0].item[5].linkId = "Practitioner.address[0].country"
* item[1].item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-practitioner#Practitioner.address.country"
* item[1].item[0].item[5].text = "Country"
* item[1].item[0].item[5].type = #string
* item[1].item[0].item[5].initial[0].valueString = "TOGO"
